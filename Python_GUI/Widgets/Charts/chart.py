...
class TopPlot(BasePlot):
    ...
    def animate(self, chart_selection):
        ...
        bottom_limit = -1
        top_limit = 1
        if chart_selection == "Torque and State":
            top_controller = (
            ...
            title = "Right Torque and State"
        elif chart_selection == "State and Set":
            top_controller = (
                self.master.controller.deviceManager._realTimeProcessor._chart_data.data1
            )
            top_measure = (
            ...
            title = "Right State and Set"
        elif chart_selection == "Toe FSR":
            top_controller = (
